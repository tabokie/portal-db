#ifndef PORTAL_UTIL_CHANNEL_H_
#define PORTAL_UTIL_CHANNEL_H_
...
template <typename ElementType, size_t BufferCapacity>
class Channel : public NoMove {
...
template <typename ElementType>
using SyncChannel = Channel<ElementType, 0>;

} // namespace coplus

#endif // PORTAL_UTIL_CHANNEL_H_